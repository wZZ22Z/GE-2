...
class GegeGraph {
   public:
    ...
    GegeGraph(EdgeList edges);

    GegeGraph(EdgeList src_sorted_edges, EdgeList dst_sorted_edges, int64_t num_nodes_in_memory);
...
/**
 * GegeGraph sublass, orders the CSR representation of the graph for fast GNN encoding.
 */
class DENSEGraph : public GegeGraph {
   public:
