...
class Batch {
   public:
    ...
    torch::Tensor node_embeddings_g_;       /**< Embedding tensor for each unique node in the the batch. Generator for GAN */
    torch::Tensor node_gradients_g_;        /**< Gradients for each node embedding in the batch. Generator for GAN */
    ...
    void embeddingsToHostG(); /**< Transfers gradients and embedding g updates to host */
