...
enum class StorageBackend { PARTITION_BUFFER, FLAT_FILE, HOST_MEMORY, DEVICE_MEMORY, MEM_PARTITION_BUFFER };
...
enum class NegativeSamplingMethod { RNS, DNS, GAN, OTHER};
