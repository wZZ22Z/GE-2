...
void init_config(py::module &m) {
    ...
    py::class_<NegativeSamplingConfig, std::shared_ptr<NegativeSamplingConfig>>(m, "NegativeSamplingConfig")
        ...
        .def_readwrite("superbatch_negative_plan_batches", &NegativeSamplingConfig::superbatch_negative_plan_batches)
    ...
    py::class_<TrainingConfig, std::shared_ptr<TrainingConfig>>(m, "TrainingConfig")
        ...
        .def_readwrite("logical_active_devices", &TrainingConfig::logical_active_devices)
    ...
    py::class_<GegeConfig, std::shared_ptr<GegeConfig>>(m, "GegeConfig")
        .def(py::init<>())
        .def_readwrite("model", &GegeConfig::model)
        .def_readwrite("storage", &GegeConfig::storage)
        .def_readwrite("training", &GegeConfig::training)
        .def_readwrite("evaluation", &GegeConfig::evaluation);
