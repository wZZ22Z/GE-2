...
void init_graph_storage(py::module &m) {
    ...
    py::class_<GraphModelStorage, std::shared_ptr<GraphModelStorage>>(m, "GraphModelStorage")
        ...
        .def(py::init([](shared_ptr<Storage> edges, shared_ptr<Storage> nodes, shared_ptr<Storage> node_features, shared_ptr<Storage> node_embeddings,
                 ...
                 if (train && node_optimizer_state == nullptr && node_embeddings != nullptr) {
                     ...
                     if (instance_of<Storage, InMemory>(node_embeddings)) {
                         ...
                         throw GegeRuntimeException("Unsupported storage backend for embeddings");
                     }
                 }
        ...
        .def("init_subgraph", &GraphModelStorage::initializeInMemorySubGraph, py::arg("buffer_state"), py::arg("device"), py::arg("device_idx"))
        .def("update_subgraph", &GraphModelStorage::updateInMemorySubGraph)
        .def("sort_all_edges", &GraphModelStorage::sortAllEdges, py::arg("device_idx"))
        ...
        .def("get_edges", &GraphModelStorage::getEdges, py::arg("indices"), py::arg("device_idx"))
        .def("get_edges_range", &GraphModelStorage::getEdgesRange, py::arg("start"), py::arg("size"), py::arg("device_idx"))
        ...
        .def("getNodeEmbeddings", &GraphModelStorage::getNodeEmbeddings, py::arg("indices"), py::arg("device_idx"))
        ...
        .def("updateAddNodeEmbeddings", &GraphModelStorage::updateAddNodeEmbeddings, py::arg("indices"), py::arg("values"), py::arg("device_idx"))
        .def("getNodeEmbeddingState", &GraphModelStorage::getNodeEmbeddingState, py::arg("indices"), py::arg("device_idx"))
        ...
        .def("updateAddNodeEmbeddingState", &GraphModelStorage::updateAddNodeEmbeddingState, py::arg("indices"), py::arg("values"), py::arg("device_idx"))
        ...
        .def("setActiveEdges", &GraphModelStorage::setActiveEdges, py::arg("active_edges"), py::arg("device_idx") = 0)
