...
from gege.tools.preprocess.converters.partitioners.torch_partitioner import TorchPartitioner
from gege.tools.preprocess.converters.readers.pandas_readers import PandasDelimitedFileReader
from gege.tools.preprocess.converters.writers.torch_writer import TorchWriter
...
class TorchEdgeListConverter(object):
    def __init__(
        ...
        stored as delimited files, numpy arrays, or pytorch tensors into the input format required by Gege.
