...
from gege.tools.preprocess.converters.readers.reader import Reader
...
class PandasDelimitedFileReader(Reader):
    def __init__(
        ...
        """
        This class converts an input dataset from a delimited file format, into the format required for input to Gege
