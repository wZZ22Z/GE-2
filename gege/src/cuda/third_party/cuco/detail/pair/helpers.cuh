...
{
  constexpr std::size_t pair_size = sizeof(First) + sizeof(Second);
  constexpr std::size_t align     = cuda::std::bit_ceil(pair_size);
  return align < std::size_t{16} ? align : std::size_t{16};
}
